...
UNITY_EXECUTABLE = "~/Unity/Hub/Editor/2021.3.23f1/Editor/Unity -projectPath ~/rp-mass-and-com/rp-mass-and-com-depth-camera-victoria/My-project/ -executeMethod PartialViewPCDGenerator.Generate"
...
for file_name in os.listdir(ESTIMATION_INPUT_DIR):
    ...
    if os.path.isfile(file_path) and file_path.endswith(ESTIMATION_INPUT_FILE_SUFFIX):
        ...
        data_file_name = re.sub('_cam_[0-9]+', '', data_file_name) # Trim the 'partial view cam suffix' 
